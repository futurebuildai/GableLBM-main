...
func (h *Handler) RegisterRoutes(mux *http.ServeMux, roleGuard ...func(http.Handler) http.Handler) {
	...
	mux.HandleFunc("GET /api/documents/print/invoice/{id}", guard(h.HandlePrintInvoice))
	mux.HandleFunc("GET /api/documents/print/pickticket/{id}", guard(h.HandlePrintPickTicket))
	mux.HandleFunc("POST /api/invoices/{id}/email", guard(h.HandleEmailInvoice))
}
