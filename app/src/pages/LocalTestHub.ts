      ...
      <div class="min-h-screen bg-deep-space text-white font-sans">
        <div class="max-w-6xl mx-auto px-6 py-12">
          <header class="flex items-center gap-3 mb-2">
            ...
            <span class="text-xs uppercase tracking-[0.2em] text-zinc-500">Local Dev Hub</span>
          </header>
          ...
          <p class="text-zinc-400 max-w-2xl mb-2">
            Choose a UI surface to test against the local backend. Demo tenant:
            <span class="text-white font-medium">Kelowna BC multi-yard</span>
